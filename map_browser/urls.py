...
urlpatterns = [
    ...
    path('edytuj-dokument/<int:pk>', views.EditDocumentForm.as_view(), name='edytuj-dokument'),
    path('usun-dokument/<int:pk>', views.DeleteDocumentView.as_view(), name='usun-dokument'),
    ...
    path('document/<int:pk>/', views.DocumentDetailView.as_view(), name='szczegoly-dokumenty'),
